...
import { typhoonKnowledgeData } from '../typhoon-knowledge-data';
...
export default function TyphoonKnowledgePage() {
  const router = useRouter();
  const course = typhoonKnowledgeData;
  ...
  const getChapterColor = (index: number) => {
    const colors = [
      ...
      'bg-indigo-500', 'bg-teal-500', 'bg-emerald-500',
    ];
  ...
  if (viewMode === 'chapter') {
    return (
      <div className="h-full overflow-auto bg-gradient-to-br from-blue-50 via-cyan-50 to-white">
        <div className="container mx-auto px-4 py-6 max-w-4xl">
          ...
          <div className="bg-white rounded-xl border border-blue-100 shadow-sm mb-4 overflow-hidden">
            ...
            {!speechLoading && speechContents.length > 0 && (
              <div className="border-b border-blue-100 p-4 bg-gradient-to-br from-blue-50/50 to-cyan-50/50">
                <DigitalAvatar
          ...
          <div className="flex items-center justify-between mb-8">
            ...
            {isLastPage ? (
              <Button
                ...
                className="border border-cyan-300 text-cyan-700 hover:bg-cyan-50"
              >
      ...
      <div className="border-2 border-black bg-white p-6 relative mb-6" style={{ boxShadow: '4px 4px 0 0 #000' }}>
        ...
        <div className="flex flex-wrap gap-3 mb-5">
          {[
            ...
            { label: '难度等级', value: course.difficulty, color: 'bg-cyan-500', icon: '📊' },
