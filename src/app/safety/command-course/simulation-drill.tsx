...
import { manualDataMap as importedManualDataMap } from '../command-manual-data';

// Re-export for use by other components
export const manualDataMap: Record<string, CommandManualData> = importedManualDataMap;
  ...
  return (
    <div className="relative border-2 border-black bg-gray-950 overflow-hidden" style={{ boxShadow: '4px 4px 0 0 #000', borderRadius: '0' }}>
      ...
      <div className="relative h-[850px] flex flex-col">
        ...
        {/* 岗位操作手册下载链接 */}
        <div className="bg-gray-950 border-t border-gray-800 p-2 flex items-center justify-center gap-2">
          <a
            href={`/safety/operation-manual?disaster=${disaster}`}
            target="_blank"
